...
export default function AboutPage() {
    ...
    // 🎬 ANIMATION FIX: using useGSAP with NO dependencies so it only runs ONCE.
    useGSAP(() => {
    ...
    }, {scope: mainRef}); // Empty dependency array prevents the 4x refresh glitch!
    ...
    return (
        <div ref={mainRef}
            ...
            <div
                ...
                {/* Responsive Fix: Added padding and constrained width */}
                <div className="relative z-10 text-center px-4 sm:px-6 w-full max-w-5xl mx-auto mt-16">
                    ...
                    {/* Responsive Fix: Scaled text down for mobile to prevent overflow */}
                    <h1 className="hero-text font-heading text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] font-black text-white tracking-tighter mb-6 leading-[1] md:leading-[0.85] drop-shadow-[0_0_40px_rgba(0,0,0,1)] uppercase">
                    ...
                    <p className="hero-text text-sm sm:text-base md:text-xl text-zinc-300 max-w-2xl mx-auto leading-relaxed font-medium">
            ...
            <div className="stats-section max-w-7xl mx-auto px-4 md:px-8 mb-24 md:mb-32 relative z-10">
                {/* Responsive Fix: Adjusted gap and padding for mobile */}
                <div
                    className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-8 p-4 sm:p-6 md:p-12 bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
                    ...
                    {[
                        ...
                        <div
                            ...
                            // Responsive Fix: Reduced padding on mobile cards
                        ...
                        >
                            ...
                            {/* Responsive Fix: Fluid text scaling for numbers */}
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 mb-24 md:mb-32 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="reveal-section space-y-10 md:space-y-12">
                        ...
                        <div
                            className="bg-[#111]/80 backdrop-blur-2xl border border-white/5 rounded-[2rem] p-6 sm:p-8 md:p-10 shadow-2xl">
                    ...
                    >
                        ...
                        <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8">
                            <div
                                className="bg-black/70 backdrop-blur-3xl p-5 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 shadow-2xl relative overflow-hidden">
                                <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                    {[
                        ...
                        <div
                            ...
                            onMouseLeave={handle3DLeave}
                            className={`team-card p-5 sm:p-6 rounded-[2rem] sm:rounded-[2.5rem] bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/30 transition-all group relative overflow-hidden shadow-2xl ${member.glow}`}
                        >
                            <div
                                className="relative w-full aspect-square rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden mb-5 sm:mb-6 border border-white/10 bg-[#111]">
                            ...
                            <h3 className="font-heading text-xs sm:text-2xl font-black text-white mb-1 uppercase tracking-tight pl-2">{member.name}</h3>
            ...
            <div className="contact-section max-w-7xl mx-auto px-4 md:px-8 mb-24 md:mb-32 relative z-10">
                <div
                    className="bg-[#111]/80 backdrop-blur-3xl border border-white/10 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-16 shadow-[0_30px_80px_rgba(0,0,0,0.8)] relative overflow-hidden">

                    <div
                        className="absolute top-0 right-0 w-full h-full opacity-10 pointer-events-none overflow-hidden">
                        <div
                            className="absolute right-[-10%] top-[-20%] w-[400px] h-[400px] sm:w-[600px] sm:h-[600px] rounded-full border-[1px] border-white/20 animate-[spin_20s_linear_infinite]"></div>
                        <div
                            className="absolute right-[5%] top-[5%] w-[250px] h-[250px] sm:w-[400px] sm:h-[400px] rounded-full border-[1px] border-white/20 animate-[spin_15s_linear_infinite_reverse]"></div>
                    </div>
                    ...
                    <div className="text-center md:text-left mb-10 sm:mb-12 relative z-10">
                        ...
                        <p className="text-zinc-400 text-sm sm:text-base font-medium tracking-wide">Reach out to
                            the {sysSettings.siteName} team for any travel inquiries or support.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 relative z-10">
                        {[
                            ...
                            <div
                                ...
                                onMouseLeave={handle3DLeave}
                                // Responsive Fix: Added min-w-0 to prevent text overflow
                                className="contact-node p-5 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2rem] bg-black/50 border border-white/10 hover:border-white/30 transition-all cursor-default shadow-xl min-w-0"
                            >
                                <div
                                ...
                                {/* Responsive Fix: Added break-all for super long email addresses on very small phones */}
            ...
            <div className="max-w-5xl mx-auto px-4 relative z-10">
                <div
                    className="reveal-section relative rounded-[2rem] sm:rounded-[3rem] overflow-hidden px-4 sm:px-6 py-16 sm:py-24 text-center bg-black border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.8)]">
                    <div
