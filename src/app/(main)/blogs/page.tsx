        ...
        <div ref={containerRef}
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 pt-16 md:pt-24 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
                    ...
                    <h1 className="hero-anim text-5xl md:text-7xl font-black text-white tracking-tighter uppercase mb-6 drop-shadow-[0_0_30px_rgba(234,88,12,0.3)]">
                        Expedition <span
                        className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600">Diaries</span>
                    </h1>
                    <p className="hero-anim text-zinc-400 text-base md:text-lg leading-relaxed font-medium tracking-wide">
                        Read firsthand experiences, destination guides, and visual logs from our completed tours across
                        the globe.
                    </p>
                </div>
                ...
                {blogs.length === 0 ? (
                    <div
                        className="hero-anim text-center py-20 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 mx-auto max-w-lg shadow-2xl">
                        <Fingerprint size={48} className="mx-auto text-zinc-600 mb-4"/>
                        <p className="text-zinc-400 text-lg font-bold uppercase tracking-widest">No Records Found</p>
                    </div>
                ) : (
                    <div
                        ...
                        {blogs.map((blog, index) => (
                            ...
                            >
                                {/* Image Section */}
                                <div
                                    className="relative w-full h-64 overflow-hidden bg-[#050505] border-b border-white/10">
                                    <Image
                                    ...
                                    {blog.youtubeUrl && (
                                        <div
                                            className="absolute top-4 right-4 bg-red-600/90 backdrop-blur-md text-white p-2.5 rounded-xl shadow-[0_0_15px_rgba(220,38,38,0.5)] border border-red-500/50 flex items-center gap-2 scale-95 group-hover:scale-100 transition-transform">
                                            <Youtube size={16} fill="currentColor"/>
                                            <span
                                                className="text-[9px] font-black uppercase tracking-widest">Video Log</span>
                                        </div>
                                    )}
                                </div>

                                {/* Content Section (Highly Readable) */}
                                <div
                                    className="p-6 md:p-8 flex flex-col relative z-10 bg-gradient-to-b from-[#0a0a0a] to-[#111]">

                                    {/* Decorative Scanner Line */}
                                    <div className="absolute top-0 left-0 w-full h-[1px] bg-orange-500/30"></div>

                                    {/* Date & Author (Monospace for HUD feel) */}
                                    <div
                                        className="flex items-center gap-4 text-[10px] font-mono text-zinc-500 mb-4 uppercase tracking-[0.15em]">
                                        <div
                                    ...
                                    <h3 className="text-2xl font-black text-white mb-3 leading-tight group-hover:text-orange-500 transition-colors tracking-tight">
                                        {blog.title}
                                    </h3>

                                    {/* Excerpt (Clean Sans-Serif) */}
                                    <p className="text-zinc-400 text-sm leading-relaxed line-clamp-3 mb-8 font-medium">
                                        {blog.excerpt || "Access full document to view field notes, imagery, and detailed mission reports..."}
                                    </p>

                                    {/* Footer Link */}
                                    <div className="flex items-center justify-between mt-auto">
                                        <span
                                            className="text-orange-500 font-bold uppercase tracking-widest text-[11px] group-hover:text-white transition-colors">Read Full Story</span>
                                        <div
                                            className="bg-white/5 p-3 rounded-xl border border-white/10 text-white group-hover:bg-orange-600 group-hover:border-orange-500 transition-colors shadow-lg">
                                            <ArrowRight size={16}
