...
export function BottomNav() {
  ...
  useGSAP(() => {
    gsap.fromTo(navRef.current, { y: 100, opacity: 0 }, { y: 0, opacity: 1, duration: 0.6, ease: "power3.out", delay: 0.3 });
  }, { scope: navRef });
          ...
          {navItems.map((item) => {
            ...
            return (
                ...
                >
                  ...
                  {isActive && (
                      <div className="absolute -bottom-2 w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_8px_var(--color-primary)]" />
                  )}
                </Link>
            );
          })}
